...
let hideScrollbar=function(){const scrollbarWidth=window.innerWidth-document.body.offsetWidth;document.body.style.paddingRight=scrollbarWidth+'px';document.body.style.overflow='hidden'};let showScrollbar=function(){document.body.style.paddingRight=originalBodyPaddingRight;document.body.style.overflow=originalBodyOverflow};let sanitizeCaption=function(caption){const regexp=/(?:(?!(<span class="([^"]+)">)|(<\/span>)|(<br>)|(<br \/>)|(<b>)|(<\/b>)|(<i>)|(<\/i>)|(<em>)|(<\/em>)|(<strong>)|(<\/strong>)|(<div>)|(<div (style|class)="([^"]).+">)|(<\/div>)|(<a href="([^"]+)">)|(<a ((href|target|style)="([^"]+)")+ (href|target|style)="([^"]+)">)|(<a (href|target|style)="([^"]+)" (href|target|style)="([^"]+)" (href|target|style)="([^"]+)">)|(<\/a))(<[^>]+>))*/gi;if(typeof caption==='string'||caption instanceof String){return caption.replaceAll(regexp,'')}
return caption}
